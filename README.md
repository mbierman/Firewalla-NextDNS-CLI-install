...
- NextDNS 1.44.4 has a bug that isn't reporting client information to the logs. This is supposed to be addressed by [1003](https://github.com/nextdns/nextdns/issues/1003) 1.44.6 partitially fixes this issue. Now part of a hostname is sent to the NextDNS log. e.g. if the device is called, "Michael's iPad" NextDNS will see, "Michaels". Hopefully they will fix this as the information is there for them to take.  [1005](https://github.com/nextdns/nextdns/issues/1005).
